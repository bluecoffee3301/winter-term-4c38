...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/winter-term-4c38)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/winter-term-4c38#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/winter-term-4c38
```

A live public deployment of this template is available at [https://winter-term-4c38.templates.workers.dev](https://winter-term-4c38.templates.workers.dev)
